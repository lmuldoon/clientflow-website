...
/***/ "./assets/src/js/scripts/_class-viewportScroll.js":
/*!********************************************************!*\
  !*** ./assets/src/js/scripts/_class-viewportScroll.js ***!
  \********************************************************/
/***/ (function() {
...
(function ($, window, document, undefined) {
  var ViewportScroll = /*#__PURE__*/function () {
    /**
    ...
    return _createClass(ViewportScroll, [{
      key: "_bindEvents",
      ...
      value: function disable() {
        var overflowState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'hidden';
        var _ = this;
        _._disabledCount++;
      ...
      key: "getDisabledCount",
      value: function getDisabledCount() {
        var _ = this;
        return _._disabledCount;
      }
    }]);
...
function animateHero() {
  ...
  var sub = document.querySelector('.hero__lede');
  var actions = document.querySelector('.hero__actions');
  var heroImg = document.querySelector('.browser-frame');
...
function initCheckout() {
  window.addEventListener('load', function () {
    ...
    var toggle = document.getElementById('js-billing-toggle');
    var grid = document.getElementById('js-pricing-grid');
    if (toggle && grid) {
    ...
    document.querySelectorAll(".plan-button").forEach(function (button) {
      button.addEventListener("click", function (e) {
        ...
        var isAnnual = grid && grid.classList.contains('is-annual');
        checkout.open({
          plan_id: planId,
          licenses: 1,
...
/* harmony import */ var _scripts_header_collapse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/header-collapse */ "./assets/src/js/scripts/header-collapse.js");
/* harmony import */ var _scripts_checkout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/checkout */ "./assets/src/js/scripts/checkout.js");
/* harmony import */ var _scripts_class_viewportScroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/_class-viewportScroll */ "./assets/src/js/scripts/_class-viewportScroll.js");
/* harmony import */ var _scripts_class_viewportScroll__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_scripts_class_viewportScroll__WEBPACK_IMPORTED_MODULE_4__);
...
_scripts_header_collapse__WEBPACK_IMPORTED_MODULE_2__.HeaderStateController.init();

(0,_scripts_checkout__WEBPACK_IMPORTED_MODULE_3__.initCheckout)();
