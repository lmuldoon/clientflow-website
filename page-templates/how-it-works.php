...
$meta->title = 'How It Works - ClientFlow';
...
════════════════════════════════════════════════════════════════════════════════ -->
	...
	<section class="section section--feature">
		<div class="container animated-up">
			...
			<p class="section-lede">ClientFlow handles the entire proposal lifecycle for you, from draft to payment, with built-in tracking, automated notifications, Stripe integration, and seamless project creation when work is approved.</p>
		</div>
	</section>
				...
				<div class="feature__image animated-up">
					<div class="browser-frame">
						...
						<div class="browser-frame__content">
							<img src="/static/images/screenshots/client-proposal.jpg?v=1" alt="ClientFlow proposal example" width="1675" height="3955" />
						</div>
					</div>
	...
	<section class="section section--feature bg-lightemerald">
		<div class="container animated-up">
			...
			<p class="section-lede">Turn accepted proposals into real payments instantly with built-in Stripe integration, automated deposit handling, and seamless client checkout flows. ClientFlow keeps proposals, invoices, payment requests, and project balances connected in one system — so you always know what's been paid, what's outstanding, and what happens next.</p>
	...
	<section class="section section--feature pt-0 bg-lightemerald">
		<div class="container">
			<div class="feature__container">
				...
				<div class="feature__image animated-up">
					<img src="/static/images/screenshots/client-payment-confirmed.jpg?v=1" alt="ClientFlow payment confirmation" width="1675" height="2310" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section section--feature">
		<div class="container animated-up">
			...
			<p class="section-lede">When a proposal is accepted, ClientFlow automatically creates a project workspace where you can manage progress, track activity, communicate with clients, and keep everything related to the job connected in one system.</p>
	...
	<section class="section section--feature pt-0">
		<div class="container">
			<div class="feature__container feature__container-right">
				...
				<div class="feature__image animated-up">
					<img src="/static/images/screenshots/admin-project.jpg?v=1" alt="ClientFlow project interface" width="1920" height="1493" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section section--feature bg-lightindigo">
		<div class="container animated-up">
			...
			<p class="section-lede">ClientFlow includes a dedicated client portal where clients can view proposals, track project progress, upload files, review deliverables, download receipts, and stay connected throughout the entire project lifecycle.</p>
	...
	<section class="section section--feature pt-0 bg-lightindigo">
		<div class="container">
			<div class="feature__container">
				...
				<div class="feature__image animated-up">
					<img src="/static/images/screenshots/client-dashboard.jpg?v=1" alt="ClientFlow client dashboard" width="1920" height="1356" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section section--feature">
		<div class="container animated-up">
			...
			<p class="section-lede">ClientFlow sends automated email notifications throughout the entire client lifecycle — from proposal delivery and payment confirmations to project updates, approval requests, and completed work notifications.</p>
	...
	<section class="section section--feature pt-0">
		<div class="container">
			<div class="feature__container feature__container-right">
				...
				<div class="feature__image animated-up">
					<img src="/static/images/screenshots/client-email.jpg?v=1" alt="ClientFlow email notification" width="1675" height="1858" />
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="feature__container">
				<div class="feature__content stack animated-up">
					...
					<p>ClientFlow also lets you export reporting data as CSV files, making it easy to share insights, analyse performance externally, or keep records for your business reporting workflows.</p>
				</div>
				<div class="feature__image animated-up">
					<img src="/static/images/screenshots/admin-analytics.jpg?v=1" alt="ClientFlow analytics interface" width="1920" height="1663" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section section--feature">
		<div class="container animated-up">
			...
			<h2 class="section-heading">Connect ClientFlow to the tools you already use</h2>
			<p class="section-lede">ClientFlow includes webhook and automation support so every key action in your workflow can trigger external tools, internal systems, or third-party integrations. From proposal creation and acceptance to payments, project updates, and completion events — you can automate your entire client lifecycle without manual intervention.</p>

			<p class="section-lede">Build workflows that connect ClientFlow to your existing stack and remove repetitive admin work from your day-to-day process.</p>
		</div>
	</section>
		...
		<div class="container">
			<div class="feature__container feature__container-right">
				<div class="feature__content stack animated-up">
					...
					<p>Trigger real-time webhooks when proposals are sent, viewed, accepted, or declined, when payments are completed, or when projects are created and updated. Connect ClientFlow to tools like Zapier, CRMs, project management platforms, spreadsheets, and internal systems to automate your entire workflow.</p>
					<p>With flexible event-based automation, ClientFlow becomes the central source of truth for your entire client workflow — powering everything from onboarding to delivery without manual updates.</p>
				</div>
				<div class="feature__image animated-up">
					<img src="/static/images/screenshots/admin-webhooks.jpg?v=1" alt="ClientFlow webhooks interface" width="1920" height="1107" />
				</div>
			</div>
		</div>
	</section>
