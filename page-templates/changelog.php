	...
	<div class="sections-header section section--gradient">
		<div class="container">
			<div class="animated-up">
				...
				<p style="color: rgba(255,255,255,0.75);">Version history and release notes for ClientFlow.</p>
			</div>
		</div>
	</div>
		...
		<div class="container small-text-container">
			<div class="changelog-entry animated-up">
				...
				<div class="stack changelog-entry__body">
					<p>First public release of ClientFlow — the client OS for WordPress freelancers.</p>
