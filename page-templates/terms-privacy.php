...
$meta->title = 'Terms & Privacy Policy — ClientFlow';
$meta->description = 'Terms of use and privacy policy for ClientFlow and wpclientflow.co.uk.';
	...
	<div class="section">
		<div class="container animated-up">
			<div class="text-container content">
				...
				<h3>Pro licence</h3>
				<p>ClientFlow Pro licences are sold through Freemius. By purchasing a licence you agree to the Freemius <a href="https://freemius.com/terms/" target="_blank" rel="noopener">Terms of Service</a>. Licences are per-site and non-transferable unless otherwise stated at the time of purchase.</p>
				...
				<h3>This website (wpclientflow.co.uk)</h3>
