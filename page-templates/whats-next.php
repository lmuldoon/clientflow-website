...
════════════════════════════════════════════════════════════════════════════════ -->
	...
	<section class="hero section--gradient">
		<div class="container">
			<div class="hero__inner">
				...
				<h1 class="text-white">The future of ClientFlow is already in motion</h1>

				<p class="hero__lede text-white">From smarter proposal workflows to deeper integrations and agency-focused tools, we're building ClientFlow to become the central platform for managing client work inside WordPress.</p>
	...
	<section class="section section--replaces bg-white">
		<div class="container animated-up">
			...
			<p class="section-lede">ClientFlow is evolving into a complete client workflow platform for freelancers and agencies. These upcoming features focus on improving proposal conversion, payment flexibility, automation, collaboration, and integrations — helping you manage more client work with less friction.</p>
			<div class="card-grid card-grid-3 animated-up">
				...
				<div class="card card--before stack">
					<span class="card__title text-indigo">Connect ClientFlow to your existing stack</span>
