		...
		<div class="site-header__inner">
			<div class="container">
				...
				<div class="site-header__bar">
					<a href="/" class="site-logo" aria-label="ClientFlow home">
					...
					<nav class="site-nav--desktop" aria-label="Main navigation">
						<ul class="site-menu">
							<li><a class="site-menu__link<?php echo $meta->slug === 'how-it-works' ? ' is-active' : ''; ?>" href="/how-it-works">How it works</a></li>
							<li><a class="site-menu__link" href="/#pricing">Pricing</a></li>
							<li><a class="site-menu__link" href="/#faq">FAQ</a></li>
